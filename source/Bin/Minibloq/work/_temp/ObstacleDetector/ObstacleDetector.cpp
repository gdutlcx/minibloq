...
void setup()
{
	...
	while(true)
	{
		...
		{
			initdisplay();display.println("STOP");display.display();
			stop();
			delay(1000);
			initdisplay();display.println("BACKWARD");display.display();
			backward(50);
			delay(500);
		}
		else
		{
			initdisplay();display.println("FORWARD");display.display();
			forward(50);
			delay(500);
			stop();
			delay(1000);
